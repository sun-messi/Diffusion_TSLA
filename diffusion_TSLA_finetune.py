# %%
# nohup python /home/sunj11/Documents/ECSE6966/Hw02/test64finetune.py > output.log 2>&1 &
# 基础包
import os
import numpy as np
    ...
    def __init__(self, root, train=True, transform=None):
        ...
        if train:
            ...
            self.img_dirs = [
                ...
                # os.path.join(root, 'TSLA_DATA2/Model_E_aware'),
                # os.path.join(root, 'TSLA_DATA2/Model_S_aware'),
                # os.path.join(root, 'TSLA_DATA2/Model_X_aware'),
                # os.path.join(root, 'TSLA_DATA2/Model_Y_aware'),
            ]
        else:
...
# 创建保存目录
save_dir = 'checkpoints_scratch_new_finetune_square64'
os.makedirs(save_dir, exist_ok=True)
...
# 加载预训练权重
pretrained_path = '/home/sunj11/Documents/ECSE6966/Hw02/checkpoints_car/checkpoint_epoch_100.pth'
print(f"Loading pretrained weights from {pretrained_path}")
checkpoint = torch.load(pretrained_path)
if 'model_state_dict' in checkpoint:
    # 如果是DataParallel保存的模型，需要处理'module.'前缀
